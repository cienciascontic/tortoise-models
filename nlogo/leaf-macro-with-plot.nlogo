...
to plot-stuff
set-current-plot "Production Rate"
...
4. The sugars go down the leaf stem and disappear. The idea is that they are being used by the plant in some way � to build leaves, stems, roots, and seeds for instance. The sugar production rate on the graph is the number of sugars on the screen at any moment.  
