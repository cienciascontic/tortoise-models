...
to do-scale-change                                    ; handles scale changes     
  ...
  ifelse grid-scale = "From Earth"
    [set d 1e4] [set d scale-to-num grid-scale]         ; handle string in scale-to-num grid-scale chooser
  update-scale d
end
...
253
356
The \"telescope-precision\" slider allows you to adjust the level of noise in data recorded by the telescope. No real telescopes can achieve a perfect precision of 100.
11
104.0
1
