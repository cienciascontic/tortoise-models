...
to startup
  ...
  set old-preset-planets "Custom"              ; used the first time through to detect user change of the preset-planets selector
  set first-step? true
...
;  scale-variables grid-scale                       ; certain variables scale with the distance from the obsever to the star   
  ...
  new-grid 2.5
  set Preset-Planets "Custom"                             ; initialize the screen with the earth
  set resetting? true
  handle-presets
  ...
  ask planets [ 
    ifelse resetting? 
      [ set x-cor 1 / sqrt 2                            ; starts this off 45° around the orbit
        ...
        set planet-diameter 2.6                           ; smallest gas planet is 2.6 times diameter of Earth!!
...
Preset-Planets
Preset-Planets
"Custom" "Earth" "Mars" "Jupiter" "Venus" "Like Mercury but 10x larger diameter" "Like Earth but 10x larger diameter" "Earth-like planet near the star" "Large rocky planet very near the star"
0
...
Star-Type
Star-Type
"M - red (temp 3120 K)" "K - orange (temp 4640 K)" "G - yellow (temp 5920 K) -> our Sun" "F - white (temp 7240 K)" "A - blue (temp 8620 K)"
0
