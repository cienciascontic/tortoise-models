...
;    if in-view? u v  [ setxy u v ]
  ...
  create-stars 1 [set shape "circle" set color yellow
    ...
    setxy 0 0 
    set size 3
    set label "Star" set label-color orange]
  set new-star star 1 
  ...
  create-view-displays 1 [set color black set size 0 setxy max-pxcor - 14  min-pycor + 1 set number 5 
    set label "au = Astronomical Unit = the distance from the Earth to the Sun"
